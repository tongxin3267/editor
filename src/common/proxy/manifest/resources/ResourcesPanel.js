    ...
    get statusBarItems() {
        ...
        switch (parseInt(this._dataGrid.sortColumnIdentifier(), 10)) {
            ...
            case 2:
                ...
                break;
            default:
                localeCompare.bind(null, "resource");
        }
...
WebInspector.DOMStorageItemsView.prototype = {
    get statusBarItems() {
        ...
        var columns = [{id: "key", title: WebInspector.UIString("Key"), editable: true, weight: 50}, {
            id: "value",
...
WebInspector.IDBDataView.prototype = {
    _createDataGrid: function () {
        ...
        if (this._isIndex)
            columns.push({
                id: "primaryKey",
                titleDOMFragment: this._keyColumnHeaderFragment(WebInspector.UIString("Primary key"), this._objectStore.keyPath)
            });
...
WebInspector.FileSystemView.EntryTreeElement.prototype = {
    onattach: function () {
        ...
        if (!this._view) {
            if (this._entry.isDirectory)
                this._view = new WebInspector.DirectoryContentView(); else {
...
WebInspector.ResourcesPanel.prototype = {
    canSearch: function () {
        ...
        var mainResource = WebInspector.resourceTreeModel.inspectedPageURL() && this.resourcesListTreeElement && this.resourcesListTreeElement.expanded ? WebInspector.resourceTreeModel.resourceForURL(WebInspector.resourceTreeModel.inspectedPageURL()) : null;
        if (mainResource)
