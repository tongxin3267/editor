function defineCommonExtensionSymbols(apiPrivate) {
    ...
    if (!apiPrivate.console)
        apiPrivate.console = {};
    apiPrivate.console.Severity = {Debug: "debug", Log: "log", Warning: "warning", Error: "error"};
...
function injectedExtensionAPI(injectedScriptId) {
    ...
    function Panels() {
        var panels = {elements: new ElementsPanel(), sources: new SourcesPanel(),};
    ...
    InspectedWindow.prototype = {
        reload: function (optionsOrUserAgent) {
            ...
            if (typeof optionsOrUserAgent === "object")
                options = optionsOrUserAgent; else if (typeof optionsOrUserAgent === "string") {
...
WebInspector.ExtensionServer.prototype = {
    hasExtensions: function () {
        ...
        var consoleMessage = new WebInspector.ConsoleMessage(WebInspector.console.target(), WebInspector.ConsoleMessage.MessageSource.JS, level, message.text, WebInspector.ConsoleMessage.MessageType.Log, message.url, message.line);
        ...
        var result = {severity: convertLevel(message.level), text: message.messageText,};
        if (message.url)
        ...
        this._registerAutosubscriptionHandler(WebInspector.extensionAPI.Events.ConsoleMessageAdded, WebInspector.console, WebInspector.ConsoleModel.Events.MessageAdded, this._notifyConsoleMessageAdded);
        this._registerAutosubscriptionHandler(WebInspector.extensionAPI.Events.NetworkRequestFinished, WebInspector.networkManager, WebInspector.NetworkManager.EventTypes.RequestFinished, this._notifyRequestFinished);
        ...
        this._registerAutosubscriptionHandler(WebInspector.extensionAPI.Events.PanelObjectSelected + "sources", WebInspector.notifications, WebInspector.SourceFrame.Events.SelectionChanged, this._notifySourceFrameSelectionChanged);
        ...
        function onTimelineSubscriptionStarted() {
            WebInspector.timelineManager.addEventListener(WebInspector.TimelineManager.EventTypes.TimelineEventRecorded, this._notifyTimelineEventRecorded, this);
        ...
        function onTimelineSubscriptionStopped() {
            ...
            WebInspector.timelineManager.removeEventListener(WebInspector.TimelineManager.EventTypes.TimelineEventRecorded, this._notifyTimelineEventRecorded, this);
        }

        this._registerSubscriptionHandler(WebInspector.extensionAPI.Events.TimelineEventRecorded, onTimelineSubscriptionStarted.bind(this), onTimelineSubscriptionStopped.bind(this));
...
WebInspector.ExtensionView = function (id, src, className) {
    ...
    this.element.className = "extension-view fill";
    this._id = id;
