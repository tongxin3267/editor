    ...
    _target: function () {
        ...
        function append(a, b) {
            if (b instanceof Node)
                a.appendChild(b); else if (typeof b !== "undefined") {
...
WebInspector.ConsoleView.prototype = {
    itemCount: function () {
        ...
        WebInspector.targetManager.targets().forEach(function (target) {
            target.consoleAgent().setMonitoringXHREnabled(enabled);
        });
...
WebInspector.ConsoleViewFilter.Events = {FilterChanged: "FilterChanged"};
WebInspector.ConsoleViewFilter.prototype = {
    addFilters: function (filterBar) {
        ...
        var levels = [{name: "error", label: WebInspector.UIString("Errors")}, {
            name: "warning",
