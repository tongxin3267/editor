...
WebInspector.ProfilesPanel = function () {
    ...
    this._target = (WebInspector.targetManager.activeTarget());
...
WebInspector.ProfileDataGridNode.prototype = {
    createCell: function (columnIdentifier) {
        ...
        if (this.profileNode.scriptId !== "0") {
            ...
            var location = new WebInspector.DebuggerModel.Location((WebInspector.targetManager.activeTarget()), this.profileNode.scriptId, lineNumber, columnNumber);
        ...
        for (var index = 0; index < count; ++index) {
            var orphanedChild = children[index], existingChild = this.childrenByCallUID[orphanedChild.callUID];
            if (existingChild)
...
WebInspector.CPUFlameChartDataProvider.prototype = {
    barHeight: function () {
        ...
        return {startTime: startTime, endTime: startTime + this._timelineData.entryTotalTimes[entryIndex]};
...
WebInspector.CPUFlameChartDataProvider.colorGenerator = function () {
    if (!WebInspector.CPUFlameChartDataProvider._colorGenerator) {
        var colorGenerator = new WebInspector.FlameChart.ColorGenerator({min: 180, max: 310, count: 7}, {
            min: 50,
            max: 80,
            count: 5
...
WebInspector.CPUProfileView.prototype = {
    selectRange: function (timeLeft, timeRight) {
        ...
        var sortProperty = {"self": "selfTime", "total": "totalTime", "function": "functionName"}[sortColumnIdentifier];
...
WebInspector.CPUProfileType.prototype = {
    fileExtension: function () {
        ...
        var message = new WebInspector.ConsoleMessage(WebInspector.console.target(), WebInspector.ConsoleMessage.MessageSource.ConsoleAPI, WebInspector.ConsoleMessage.MessageLevel.Debug, messageText, type, undefined, undefined, undefined, undefined, undefined, [{
            functionName: "",
...
WebInspector.HeapSnapshotProgressEvent = {Update: "ProgressUpdate"};
...
WebInspector.HeapSnapshotGridNode.prototype = {
    createProvider: function () {
        ...
        for (var node = this.children[0]; node; node = node.traverseNextNode(true, this, true))
            if (node.dispose)
                node.dispose();
    }, _reachableFromWindow: false, queryObjectContent: function (callback) {
...
WebInspector.HeapSnapshotGenericObjectNode = function (dataGrid, node) {
    ...
    if (this._type === "string")
        this._reachableFromWindow = true; else if (this._type === "object" && this._name.startsWith("Window")) {
...
WebInspector.TrackingHeapSnapshotProfileType.prototype = {
    heapStatsUpdate: function (samples) {
        ...
        this._profileSamples = {'sizes': [], 'ids': [], 'timestamps': [], 'max': [], 'totalTime': 30000};
...
WebInspector.CanvasProfileView = function (profile) {
    ...
    var columns = [{title: "#", sortable: false, width: "5%"}, {
...
WebInspector.CanvasProfileView.prototype = {
    dispose: function () {
        ...
        if (evalResult)
            showObjectPopover.call(this, null, evalResult); else {
    ...
    selectResource: function (resourceId) {
        ...
        if (descriptor.isArray && descriptor.values) {
            if (typeof nameElement === "string")
                nameElement += "[" + descriptor.values.length + "]"; else {
                var element = document.createElement("span");
