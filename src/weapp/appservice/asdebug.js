...
!function () {
    function e(e) {
        ...
        o.to = "backgroundjs", o.comefrom = "webframe", o.command = "COMMAND_FROM_ASJS", o.appid = W, o.appname = C, o.apphash = T, o.webviewID = L, window.postMessage(o, "*")
    }

    function o(e) {
        e.command = "COMMAND_FROM_ASJS", e.appid = W, e.appname = C, e.apphash = T, e.webviewID = L;
        var o = "____sdk____" + JSON.stringify(e), n = prompt(o);
        n = JSON.parse(n), delete n.to, a(n)
    }

    function n(e) {
        e.to = "contentscript", e.comefrom = "webframe", e.webviewID = L, window.postMessage(e, "*")
    }
    ...
    function t(n, t, a) {
        var i = r();
        z[i] = a;
        var s = /Sync$/.test(n), c = {sdkName: n, args: t, callbackID: i};
        s ? o(c) : e(c)
    }
    ...
    function a(o) {
        ...
        if ("MSG_FROM_WEBVIEW" === n) {
            var c = r.eventName, u = r.type, p = r.data || {};
        ...
        }); else if ("WRITE_APP_DATA" === n)for (var l in r) {
            var g = r[l], f = g.__webviewId__;
            WeixinJSBridge.publish("appDataChange", {data: {data: g}}, [f], !0)
        }
    }
    ...
    function i(e, o) {
        ...
        try {
            for (var n = G.projectConfig, r = n.Network, t = "webscoket" === o ? r.WsRequestDomain : r.RequestDomain, a = 0; a < t.length; a++)if (0 === e.indexOf(t[a]))return !0
        } catch (i) {
    ...
    function s(e, o, n) {
        if (H++, H > B)return H--, n && n({errMsg: "request:fail;"}), void console.error("%c 最多同时发起 " + B + " 个 wx.request 请求", "color: red; font-size: x-large");
        var r = o.url, t = o.header || {};
        if (!i(r))return H--, n && n({errMsg: "request:fail;"}), void console.error("%c URL 域名不合法，请在 mp 后台配置后重试", "color: red; font-size: x-large");
        var a, s = new XMLHttpRequest, c = o.method || "POST", u = (o.complete, G.networkTimeout && G.networkTimeout.request);
        s.open(c, o.url, !0), s.onreadystatechange = function () {
            if (3 == s.readyState, 4 == s.readyState) {
                s.onreadystatechange = null;
                var e = s.status;
                0 == e ? n && n({errMsg: "request:fail"}) : n && n({
                    errMsg: "request:ok",
                    data: s.responseText,
                    statusCode: e
                }), H--, a && clearTimeout(a)
        ...
        "POST" != c || p || s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), "number" == typeof u && (a = setTimeout(function () {
            s.abort("timeout"), o.complete && o.complete(), o.complete = null, H--, n && n({errMsg: "request:fail"})
        }, u));
        var g = "string" == typeof o.data ? o.data : null;
        try {
            s.send(g)
        } catch (f) {
            H--, n && n({errMsg: "request:fail"})
        }
    }
    ...
    function p(e, o, n) {
        var r = o.url, t = o.header;
        if (!i(r, "webscoket"))return n && n({errMsg: "closeSocket:fail"}), void console.error("%c URL 域名不合法，请在 mp 后台配置后，重启项目继续测试", "color: red; font-size: x-large");
        K = new WebSocket(r);
        for (var a in t)t.hasOwnProperty(a);
        K.onopen = function () {
            u("open")
        }, K.onmessage = function (e) {
            u("message", {data: e.data})
    ...
    function d(e, o, n) {
        K ? (K.close(), K = null, n && n({errMsg: "closeSocket:ok"})) : n && n({errMsg: "closeSocket:fail"})
    }

    function l(e, o, n) {
        var r = o.data;
        if (K)try {
            K.send(r), n && n({errMsg: "sendSocketMessage:ok"})
        } catch (t) {
            n && n({errMsg: "sendSocketMessage:fail," + t.message})
    ...
    var T = __wxConfig.apphash, W = __wxConfig.appid, C = __wxConfig.appname, O = __wxConfig.isTourist, R = O ? Object.assign(__wxConfig.userInfo) : {};
    delete __wxConfig.userInfo;
    var B, J = !1, P = [], q = navigator.userAgent, L = parseInt(q.match(/webview\/(\d*)/)[1]), F = [], z = {}, G = Object.assign({
        domain: [""],
        networkTimeout: {request: 3e4, connectSocket: 3e4, uploadFile: 3e4, downloadFile: 3e4}
    }, __wxConfig), H = 0, V = __wxConfig.appserviceConfig.AppserviceMaxDataSize;
    try {
    ...
    var U = {
        ...
        chooseVideo: !0,
        saveFile: !0
    }, j = {login: !0, authorize: !0, operateWXData: !0};
    ...
    var K = null, $ = {open: [], message: [], error: [], close: []}, Y = {
        onAppLaunch: !1,
        onAppShow: !1,
        onAppTerminate: [],
        onAppRoute: [],
    ...
    }, Q = {onMusicPlay: [], onMusicPause: [], onMusicEnd: [], onMusicError: []};
    WeixinJSBridge._subscribe = {}, WeixinJSBridge.subscribe = function (e, o) {
        ...
        if (J && (console.group(new Date + " WeixinJSBridge publish " + o), console.debug(o, n, r, t), console.groupEnd()), n && 0 !== o.indexOf("canvas")) {
            var a = JSON.stringify(n), i = a.length;
        ...
        P.push({
            ...
            appData: __wxAppData,
            sdkName: "send_app_data"
        }), e({eventName: o, data: n, sdkName: "publish", webviewIds: r})
        ...
        return J && (console.group(new Date + " WeixinJSBridge invoke " + e), console.debug(e, o, n), console.groupEnd()), O && j[e] ? (console.warn("请注意无 AppID 关联下，调用 wx." + e + " 是受限的, API 的返回是工具的模拟返回"), void setTimeout(function () {
            ...
            }) : "authorize" === e && n({errMsg: "authorize:fail"})
        })) : (P.push({
            type: "invoke",
            eventName: e,
            data: arguments,
            ...
            if (o.errMsg.indexOf("ok") > -1 && ("navigateTo" === e || "redirectTo" === e)) {
                ...
                var p = e;
                S("onAppRoute", {path: a, query: i, openType: p, webviewId: o.webviewId})
            }
            n && n(o)
    ...
    }, n({command: "SHAKE_HANDS"}), window.addEventListener("load", function () {
        F.forEach(function (e) {
            a(e)
        }), F = []
    }), window.showDebugInfo = function (e, o) {
        var n = P.filter(function (n) {
            var r = !e || (Array.isArray(e) ? e.includes(n.type) : n.type === e), t = !o || (Array.isArray(o) ? o.includes(n.eventName) : n.eventName === o);
            if (r && t)return n
        });
        ...
        }, {fun: "closeDebug"}, {fun: "showDebugInfoTable"}, {fun: "openToolsLog"}, {fun: "openVendor"}])
    }
}();