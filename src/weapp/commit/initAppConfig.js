"use strict";
function init() {
    var e = require("fs"), t = require("path");
    _exports = function (a, o, i) {
        try {
            !function () {
                var n = o.isBuildForTest, r = {}, s = void 0, c = a.projectpath, l = t.join(c, "app.json");
                ...
                var v = s.tabBar || {}, w = v.list || [];
                w.forEach(function (a) {
                    a.pagePath = a.pagePath + ".html";
                    var o = a.iconPath, i = a.selectedIconPath;
                    if (o) {
                        var n = void 0;
            ...
            i("生成 app-config 错误，错误信息: " + n.toString())
        }
    }
}
var _exports;
