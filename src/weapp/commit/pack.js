"use strict";
function init() {
    var e = require("glob"), r = require("fs"), n = require("path"), t = require("../../common/log/log.js");
    _exports = function (f, u, i) {
        var c = 0, o = 1, a = 2, B = 3, w = 4, l = [new Buffer(1), new Buffer(4), new Buffer(4), new Buffer(4), new Buffer(1)];
        ...
        e(f + "/**", {nodir: !0}, function (e, c) {
            e ? t.error(e) : !function () {
                s = c.length, c.forEach(function (e) {
                    var t = r.readFileSync(e), u = n.relative(f, e), i = new Buffer("/" + u.replace(/\\/g, "/"));
                    g.push(i), p.push(t)
                });
                ...
                h = g.map(function (r, n) {
                    ...
                    var f = new Buffer(4), u = p[n].length, i = e;
