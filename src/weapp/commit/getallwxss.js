...
function init() {
    function r(r, s) {
        ...
        function a(r, i, e) {
            var n = i;
            if (r[i] == e) {
                for (var t = i + 1; t < r.length; t++)if ("\\" == r[t])t++; else if (r[t] == e)return t - n;
                throw C + o + e
            }
            return 0
        }
        ...
        function l(r, i) {
            g[++O] = r.id, b[O] = x[i.id], x[i.id] = O, y[r.id]++
        }
        ...
        function d(r, i) {
            ...
            if ("@import" == r.substr(i, 7)) {
                for (var t = i + 8; t < r.length;) {
                    if (e = u(r, t, "//", "\n"))t += e; else if (e = u(r, t, "/*", "*/"))t += e; else if ("'" == r[t] || '"' == r[t])break;
                    t++
                }
        ...
        function c(r) {
            ...
            try {
                ...
                var s, p = h(r), v = [0];
                S[f.id] = !0, F.push(f);
                for (var g = 0; g < o.length; g++)if (s = u(o, g, "//", "\n"))g += s; else if (s = u(o, g, "/*", "*/"))g += s; else if (s = a(o, g, "'"))g += s; else if (s = a(o, g, '"'))g += s; else {
                    var x;
                    if (x = d(o, g), x.dis) {
                        ...
                        if (l(f, O), S[O.id])for (var q = O.path; ;) {
                            var z = F.pop();
        ...
        var v, g = [], x = [], b = [], w = [], k = [], m = [], y = [], O = 0, _ = 0, q = "", j = "\t\n\r ", C = "", F = [], S = [];
        try {
            c(r), v = _;
    ...
    var i = require("fs"), e = require("path"), n = "lack of semicolon after import", t = "Circular dependencies", f = ": lack of */", o = ": lack of ";
    _exports = function (i, e) {
        r(i, function (r, i) {
            e(r, i)
        })
    }
